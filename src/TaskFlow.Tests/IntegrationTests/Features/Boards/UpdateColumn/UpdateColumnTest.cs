...
namespace TaskFlow.Tests.IntegrationTests.Features.Boards.UpdateColumn;
...
public class UpdateColumnTest : TaskFlowClassFixture
{
    ...
    public async Task Error_Board_Not_Found()
    {
        ...
        var response = await DoPatch(requestUri: $"{Route}/{fakeBoardId}/columns/{columnId}", request, _boardOwnerToken);
