...
namespace TaskFlow.Tests.IntegrationTests.Features.Boards.Users.RemoveUser;

public class RemoveUserTest : TaskFlowClassFixture
{
    ...
    public RemoveUserTest(CustomWebApplicationFactory webApplicationFactory) : base(webApplicationFactory)
    {
