...
namespace TaskFlow.Tests.IntegrationTests.Features.Boards.Users.AddUser;

public class AddUserTest : TaskFlowClassFixture
{
    ...
    public AddUserTest(CustomWebApplicationFactory webApplicationFactory) : base(webApplicationFactory)
    {
